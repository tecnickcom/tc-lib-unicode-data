...
PKGNAME=php-tc-lib-pdf-font-data
...
help:
	@echo ""
	@echo "Welcome to tc-lib-pdf-font-data make."
...
docs:
	@rm -rf target/phpdocs && ./vendor/phpdocumentor/phpdocumentor/bin/phpdoc project:run --target="target/phpdocs/" --directory="src/" --ignore="vendor/" --encoding="UTF-8" --title="tc-lib-pdf-font-data" --parseprivate
