# Contributing to tc-lib-unicode-data
...
> **Pull requests are restricted to project collaborators.** If you are not a collaborator, [open an issue](https://github.com/tecnickcom/tc-lib-unicode-data/issues) describing the bug or feature instead.
>
...
- Optional: `rpmbuild` (RPM packaging), `debuild` (DEB packaging, from `devscripts`)
...
2. **Search [existing issues](https://github.com/tecnickcom/tc-lib-unicode-data/issues)** to avoid duplicates.

If no existing issue matches, [open a new one](https://github.com/tecnickcom/tc-lib-unicode-data/issues/new) and include:

- A **clear title and description** of the problem.
- The **library version** (`composer show tecnickcom/tc-lib-unicode-data`) and PHP version.
...
> Only project collaborators can open pull requests. If you are not a collaborator, [open an issue](https://github.com/tecnickcom/tc-lib-unicode-data/issues/new) describing the bug (see [Reporting a Bug](#reporting-a-bug)).
...
1. **Open a Feature Request** on [GitHub Issues](https://github.com/tecnickcom/tc-lib-unicode-data/issues/new) describing the use case and the expected behaviour. Keep it at the level of intent and API surface; do not attach an implementation.
...
| `make gendata` | Regenerate the UCD-derived source files |
...
XDEBUG_MODE=coverage ./vendor/bin/phpunit test/ArabicTest.php
```
...
> Opening pull requests is restricted to project collaborators. If you are an external contributor, please [open an issue](https://github.com/tecnickcom/tc-lib-unicode-data/issues/new) describing the problem or feature in detail instead.
...
If you have a question that is not covered here, feel free to open a [GitHub Discussion](https://github.com/tecnickcom/tc-lib-unicode-data/discussions) or contact the maintainer at [info@tecnick.com](mailto:info@tecnick.com).
